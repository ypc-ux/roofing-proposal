  ...
  return (
    <main className="min-h-screen w-full bg-[#0B1426] text-white">
      ...
      <section className="relative flex flex-col items-center justify-center text-center px-6" style={{ minHeight: "85vh", paddingTop: "6rem" }}>
        ...
        <div className="relative overflow-hidden" style={{ width: "100%", height: "100%", position: "absolute", top: 0, left: 0 }}>
          <Meteors number={15} />
          <Particles quantity={80} color="#a855f7" ease={70} size={0.05} staticity={50} vy={0.2} />
        </div>
        <div className="relative z-10 mx-auto space-y-6" style={{ maxWidth: "44rem" }}>
          ...
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight leading-[1.05]">
            Your scripts.<br /><AuroraText colors={["#a855f7", "#8ed1fc", "#e879f9"]}>Your rizz.</AuroraText><br />One app.
          </h1>
          <TextAnimate animation="blurInUp" by="word" className="text-xl text-white/50 leading-relaxed max-w-lg mx-auto">
...
{/*P2*/}
      ...
      <section id="how" className="py-20 px-6 relative overflow-hidden">
        ...
        <div className="mx-auto" style={{ maxWidth: "56rem" }}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((f, i) => (
              <MagicCard key={i} className="bg-[#0f1a2e] border border-[#a855f7]/10 rounded-2xl p-8 cursor-default" gradientColor="#a855f722" gradientOpacity={0.4}>
      ...
      <section id="waitlist" className="py-24 px-6 relative overflow-hidden text-center" style={{ background: "#0d1520" }}>
        ...
        <div className="mx-auto" style={{ maxWidth: "32rem" }}>
          <div className="relative bg-[#0f1a2e] rounded-2xl p-10 overflow-hidden">
            <BorderBeam size={200} duration={6} colorFrom="#a855f7" colorTo="#8ed1fc" />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <input type="email" placeholder="your@email.com" className="w-full sm:w-auto px-6 py-4 rounded-xl bg-[#0B1426] border border-[#a855f7]/20 text-white placeholder-white/20 focus:border-[#a855f7]/50 focus:outline-none" style={{ minWidth: "240px" }} />
