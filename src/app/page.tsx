export default function Proposal() {
  ...
  return (
    <main>
      <section className="flex flex-col items-center justify-center min-h-screen text-center relative overflow-hidden">
        <div className="mesh-bg" />
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="fade-in"><span className="inline-block px-4 py-1.5 rounded-full text-xs font-medium tracking-wider uppercase bg-#0693e3/10 text-#8ed1fc border border-#0693e3/20">Partnership Proposal</span></div>
          ...
          <div className="fade-in fade-in-delay-3 flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <a href="#pricing" className="cta-pulse inline-flex items-center px-8 py-4 rounded-xl bg-#0693e3 text-white font-semibold text-lg hover:bg-emerald-600 transition-all hover:scale-105">Pay $2,000 Setup</a>
      ...
      <section className="py-24 relative overflow-hidden"><div className="mesh-bg" /><div className="max-w-5xl mx-auto">
      ...
      <section className="py-24 relative overflow-hidden" id="how-it-works"><div className="mesh-bg" /><div className="max-w-5xl mx-auto text-center">
...
{/*CONTINUED*/}
      <div className="section-divider max-w-5xl mx-auto"/>
      <section className="py-24 relative overflow-hidden" id="qualified-leads"><div className="mesh-bg" /><div className="max-w-5xl mx-auto">
...
{/*CONTINUED2*/}
      <div className="section-divider max-w-5xl mx-auto"/>
      <section className="py-24 relative overflow-hidden" id="pricing"><div className="mesh-bg" /><div className="max-w-5xl mx-auto">
        <div className="text-center mb-16">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="glow-card p-10 text-center space-y-6">
            ...
            <a href="https://whop.com/velocitydemos/velocitydemos-marketing-services/" target="_blank" rel="noopener noreferrer" className="mt-4 inline-flex items-center px-6 py-3 rounded-xl bg-#0693e3 text-white font-semibold hover:bg-emerald-600 transition-all">Pay Setup Fee</a>
            ...
            <ul className="space-y-3 text-left text-neutral-400">
              {['Done-for-you Meta ads','Done-for-you Google ads','Geo-targeted audience','Landing page creation','AI call system setup','Calendar integration','Tracking dashboard'].map((item,i) => (
                <li key={i} className="flex items-start gap-3"><svg className="w-5 h-5 text-#8ed1fc shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7"/></svg>{item}</li>
              ))}
            </ul>
          </div>
...
{/*CONTINUED3*/}
      ...
      <div className="section-divider max-w-5xl mx-auto"/>
      <section className="py-24 relative overflow-hidden"><div className="mesh-bg" /><div className="max-w-4xl mx-auto text-center">
...
{/*CONTINUED4*/}
      ...
      <section className="py-32 relative overflow-hidden"><div className="mesh-bg" /><div className="max-w-3xl mx-auto text-center space-y-8">
        ...
        <a href="https://whop.com/velocitydemos/velocitydemos-marketing-services/" target="_blank" rel="noopener noreferrer" className="cta-pulse inline-flex items-center px-12 py-5 rounded-xl bg-#0693e3 text-white font-bold text-xl hover:bg-emerald-600 transition-all hover:scale-105">Pay $2,000 Setup Fee</a>
